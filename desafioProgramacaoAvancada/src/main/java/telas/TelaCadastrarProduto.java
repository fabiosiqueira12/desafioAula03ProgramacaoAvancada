...
public class TelaCadastrarProduto extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String descricao = this.jTextField2.getText();
        double precoVenda = Double.parseDouble(this.jTextField3.getText());
        double precoCusto = Double.parseDouble(this.jTextField4.getText());
        
        Produto p = new Produto(nome, descricao, precoVenda, precoCusto);
        
        RepositorioProduto repositorioProduto = RepositorioProduto.getInstancia();
        
        
        repositorioProduto.adicionaProduto(p);
